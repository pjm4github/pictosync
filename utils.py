...
def _scale_record(rec: dict, a: float, b: float, normalized: bool) -> dict:
    ...
    bbox_kinds = ("rect", "ellipse", "roundedrect", "hexagon", "cylinder", "blockarrow", "polygon", "curve", "seqblock")
...
ANNOTATION_KEY_ORDER = ["id", "kind", "parent_id", "connections", "ports", "children", "geom", "meta", "style", "z"]
